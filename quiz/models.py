...
class Question(TimeStampedModel):
    ...
    maximum_marks = models.DecimalField(gettext('Maximum Marks'), default=4, decimal_places=2, max_digits=6)
...
class Choice(TimeStampedModel):
    ...
    is_correct = models.BooleanField(gettext('Is this answer correct?'), default=False, null=False)
